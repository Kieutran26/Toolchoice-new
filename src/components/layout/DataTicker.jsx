...
export default function DataTicker({ totalTools, categories }) {
  ...
  return (
    <div className="h-7 border-b border-border bg-secondary/30 overflow-hidden flex items-center">
      <div className="ticker-scroll whitespace-nowrap flex">
        <span className="text-[10px] font-mono tracking-[0.1em] text-muted-foreground/60 px-4">
